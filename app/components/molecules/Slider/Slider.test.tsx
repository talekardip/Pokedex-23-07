...
//   beforeEach(() => {
//     render(<Slider isOpen={true} onToggle={mockOnToggle} />);
//   });
...
// Mock the MultiSlider component
jest.mock('../../atoms/Multislider/MultiSlider', () => jest.fn(() => <div data-testid="multi-slider">Mocked MultiSlider</div>));
...
describe('Slider', () => {
  ...
  it('renders the dropdown button', () => {
    const dropdownButton = screen.getByText('Stats');
    expect(dropdownButton).toBeInTheDocument();
  });
