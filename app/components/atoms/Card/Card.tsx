  ...
  return (
    <div>
      ...
      <Link href={`${endpoints.navigatePokemonPage}${id}`}>
        <div
          className={`w-full max-w-[170px] mx-auto h-[250px] rounded overflow-hidden border-2 border-dashed border-gray-300 cursor-pointer bg-gradient-to-b ${fromcolor} ${tocolor}`}          
        >
